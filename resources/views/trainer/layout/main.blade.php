...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo ">
    <a href="{{ url('trainer') }}" class="app-brand-link">
  ...
  <ul class="menu-inner py-1">
    <li class="menu-item">
      <a href="{{ url('trainer') }}" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item">
          <a href="{{ route('active') }}" class="menu-link">
            <div data-i18n="Active Members">Active Members</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="{{ route('inactive') }}" class="menu-link">
            <div data-i18n="Inactive Members">Inactive Members</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="{{ route ('enquiry') }}" class="menu-link" target="_blank">
