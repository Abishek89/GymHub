              ...
              <div class="card mb-4">
                <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                  <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                    <img src="{{ URL::to('uploads/customers/'.$user->image) }}" alt="user image" class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img" height="100px" width="150px">
                  </div>
            ...
            <div class="card card-action mb-4">
              <div class="card-body">
                ...
                <ul class="list-unstyled mb-4 mt-3">
                  ...
                  <li class="d-flex align-items-center mb-3"><i class="bx bx-star"></i><span class="fw-semibold mx-2">Role:</span> <span>Trainee</span></li>
                  <li class="d-flex align-items-center mb-3"><i class="bx bx-flag"></i><span class="fw-semibold mx-2">Weight:</span> <span>{{ $user->weight }} Kg</span></li>
                  <li class="d-flex align-items-center mb-3"><i class="bx bx-detail"></i><span class="fw-semibold mx-2">Height:</span> <span>{{ $user->height }} cm</span></li>
                </ul>
                ...
                <ul class="list-unstyled mb-4 mt-3">
                  ...
                  <li class="d-flex align-items-center mb-3"><i class="bx bx-detail"></i><span class="fw-semibold mx-2">DOB:</span> <span>{{ $user->DOB }}</span></li>
