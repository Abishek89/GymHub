...
document.addEventListener("DOMContentLoaded", function () {
    {
        ...
        o && new PerfectScrollbar(o, {
            ...
            e.preventDefault(), v.value && ((e = document.createElement("div")).className = "chat-message-text mt-2", e.innerHTML = '<p class="mb-0">' + v.value + "</p>", document.querySelector("li:last-child .chat-message-wrapper").appendChild(e), v.value = "", a())
        });
        ...
        }), b.length && null != (c = c || webkitSpeechRecognition) && (r = new c, s = !1, b.on("click", function () {
            const t = $(this);
